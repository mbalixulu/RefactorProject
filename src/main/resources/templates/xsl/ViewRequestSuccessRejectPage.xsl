...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/requestWrapper">
        <page xmlns:ns1="http://ws.online.fnb.co.za/v1/common/"
              id="ViewRequestSuccessRejectPage"
              title="View Request Reject Success"
              template="main" layout="" version="1">

            <symbol xsi:type="ns1:formLayout">
                <ns1:form ns1:action="" ns1:name="ViewRequestSuccessRejectPage">
            ...
            <!-- Finish -> back to the exact request -->
