...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <page xmlns:ns1="http://ws.online.fnb.co.za/v1/common/"
              xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" id="ticketTable"
              title="Ticket Table" template="main" layout="" version="1">
            <!--Heading-->
            <symbol xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="ns1:subTabGroup"
            ...
            <symbol xsi:type="ns1:viewGroup" ns1:align="left">
                ...
                <ns1:view ns1:text="On hold" ns1:type="active" ns1:id="onHold"
                    ...
                    <ns1:sections ns1:id="tableSection" ns1:align="center" ns1:width="full"
                        ...
                        <xsl:attribute name="ns1:label">
                            <xsl:choose>
                                ...
                                <xsl:otherwise>On Hold tickets</xsl:otherwise>
                            </xsl:choose>
                        </xsl:attribute>

                        <xsl:if test="requests/requestDTO/subStatus = 'Admin'">
                            <ns1:symbol xsi:type="ns1:fullTable" ns1:id="TemplateTable"
                                        ns1:headingColor="primary" ns1:defaultSortIndex="7"
                                        ...
                                        <ns1:cell ns1:col_id="assignedUser">
                                            <ns1:cellItem>
                                                <ns1:item xsi:type="ns1:simpleText"
                                                          ns1:label="Assigned User">
                                                    <ns1:value>
                                                        <xsl:choose>
                                                            <xsl:when
                                                                    test="normalize-space(assignedUser) != ''">
                                                                <xsl:value-of
                                                                        select="assignedUser"/>
                                                            </xsl:when>
