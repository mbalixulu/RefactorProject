...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <page xmlns:ns1="http://ws.online.fnb.co.za/v1/common/"
              ...
              id="adminInProgressPage" title="Admin In Progress Page" template="main" layout="" version="1">
            ...
            <symbol xsi:type="ns1:viewGroup" ns1:align="left">
                ...
                <ns1:view ns1:text="In Progress"    ns1:type="active"   ns1:id="pendingRequests" ns1:url="app-domain/mandates-and-resolutions/adminInProgress"/>
                    ...
                    <ns1:sections ns1:id="tableSection" ns1:align="center" ns1:width="full" ns1:tooltip="">
                        <xsl:attribute name="ns1:label">
                            <xsl:choose>
                                ...
                                <xsl:otherwise>In Progress requests</xsl:otherwise>
                            </xsl:choose>
                        </xsl:attribute>
