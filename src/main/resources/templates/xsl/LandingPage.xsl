    ...
    <xsl:template match="/">
        <page xmlns:ns1="http://ws.online.fnb.co.za/v1/common/"
            ...
            <symbol xsi:type="ns1:viewGroup" ns1:align="left">
                ...
                <ns1:view ns1:text="In Progress" ns1:type="active" ns1:id="inProgress"
                ...
                <ns1:form ns1:action="app-domain/mandates-and-resolutions" ns1:name="fetchTicketForm">
                    <ns1:sections ns1:id="tableSection" ns1:align="center" ns1:width="full" ns1:tooltip="">
                        ...
                        <xsl:if test="requests/requestDTO/subStatus = 'Admin'">
                            ...
                            <!--Create Request Button at Footer as totalsRow-->
                            <ns1:totalsRow>
                                <ns1:cell ns1:colSpan="8" ns1:align="center">
                                    <ns1:cellItem>
                                        <ns1:item xsi:type="ns1:imageButton"
                                                  ns1:target="main"
